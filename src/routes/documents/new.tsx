...
function NewDocumentPage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		e.preventDefault();
		if (!formData.subject || !formData.documentType || !formData.registryNumber || !formData.direction || !formData.organizationId) {
		...
		<div className="space-y-6">
			<div className="flex items-center gap-4">
				...
				<div>
					...
					<p className="text-sm text-muted-foreground">Enter document details to register it in the system</p>
				</div>
			</div>
						...
						<div className="grid grid-cols-2 gap-4">
							<div className="space-y-2">
								...
								<Input 
									...
									onChange={(e) => updateForm({ registryNumber: e.target.value })}
